...
namespace CryptoStatistic.Web.Bypasses
{
    public class CloudflareEvader
    {
        ...
        public static WebClient CreateBypassedWebClient(string url)
        {
            ...
            catch (WebException ex) //We usually get this because of a 503 service not available.
            {
                ...
                string tempString = "";
                int af1 = 0, af2 = 0;
                af1 = html.IndexOf("var s,t,o,p");

                af2 = html.IndexOf(";", af1);
                af2++;
                tempString += html.Substring(af1, af2 - af1);

                //==============Cпapcили пepвyю cтpoкy============

                tempString += "t = \"" + uri.Host + "\";";

                //==============Дoпиcaли дoмeн в пepeмeннyю t============

                af1 = html.IndexOf("ge-form');");
                af1 += 20;
                af2 = html.IndexOf("t.length;", af1);
                af2 += 9;
                tempString += html.Substring(af1, af2 - af1);
                tempString = tempString.Replace("a.value", "a");

                //Execute it. 
                long solved = long.Parse(JSEngine.Execute(tempString).GetCompletionValue().ToObject().ToString());
